...
return new class extends Migration
{
    ...
    {
        Schema::create('target_shift_pagis', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained('users');
            $table->bigInteger('omset_global')->nullable();
            $table->bigInteger('tc_global')->nullable();
    ...
    {
        Schema::dropIfExists('target_shift_pagis');
    }
};
