...
return new class extends Migration
{
    ...
    {
        Schema::create('actual_shift_siangs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained('users');
            $table->bigInteger('actual_omset_global')->nullable();
            $table->bigInteger('actual_tc_global')->nullable();
    ...
    {
        Schema::dropIfExists('actual_shift_siangs');
    }
};
